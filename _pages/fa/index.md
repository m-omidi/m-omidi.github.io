...
<section class="resume-section" style="font-family: 'Vazir', sans-serif; direction: rtl;">
  ...
  <p class="profile-text" style="
    ...
    font-family: 'Vazir', sans-serif;
    direction: rtl;">
    مسیر حرفه‌ای من در مهندسی برق از سال ۱۳۷۹ آغاز شد و با تلفیق تحصیلات دانشگاهی و تجربه عملی در حوزه اتوماسیون و کنترل شکل گرفت. در ادامه، با تمرکز بیشتر بر ریاضیات، برنامه‌نویسی و مدل‌سازی، به‌ویژه در حل مسائل پیچیده مهندسی برق، این مسیر عمق بیشتری پیدا کرد. تجربه‌های پژوهشی دیدگاه تحلیلی و رویکرد منظم‌تری به من بخشید و کار مستقیم با ماشین‌های الکتریکی نیز مهارت‌های عملی‌ام را تقویت کرد. در حال حاضر تمرکز اصلی من بر انجام پروژه‌های تخصصی است که در آن‌ها تلفیق دانش مهندسی، ریاضی و نرم‌افزار امکان بررسی و حل خلاقانه مسائل پیشرفته را فراهم می‌سازد.
  </p>
</section>
...
<div class="experience-item-fa" style="margin-bottom: 2em;">
  <p class="company" style="margin-bottom: 0.1em; font-size: 0.9em; direction: rtl; color: #bcc0cb;">فعالیت مستقل</p>
  <h3 style="margin: 0 0 0.1em 0; font-size: 1em; font-weight: bold; color: #3498db; direction: rtl;">مهندس برق، برنامه نویس و تحلیلگر داده – پروژه‌ای</h3>
  <p class="duration" style="margin: 0; font-size: 0.85em; direction: rtl;">۲۰۲۳ - امروز (۲ سال و ۶ ماه)</p>
  <ul class="responsibilities" style="font-size: 0.9em; line-height: 1.8; padding-right: 1.2em; margin-top: 0.8em; list-style-position: inside; font-family: 'Vazir', sans-serif; direction: rtl;">
    <li>
      اجرای راه‌حل‌های پروژه‌ای برای شرکت‌های مختلف با تمرکز بر اتوماسیون، ماشین‌های الکتریکی و سیستم‌های کنترل. پروژه‌ها شامل مدل‌سازی ریاضی، شبیه‌سازی در MATLAB/Python و توسعه ابزارهای نرم‌افزاری سفارشی برای پشتیبانی از تحلیل‌های مهندسی و فرآیندهای تصمیم‌گیری بودند.
    </li>
    <li>
      توسعه یک ابزار نرم‌افزاری گرافیکی برای ثبت داده‌ها و تنظیمات کاربران به‌منظور انجام محاسبات خودکار، تحلیل داده‌ها و مصورسازی نتایج. این ابزار امکان تغییر سریع پارامترها و نمایش فوری نتایج تحلیلی را فراهم کرد که باعث افزایش دقت و بهره‌وری شد.
    </li>
    <li>
      طراحی یک مدل مبتنی بر MATLAB برای تحلیل حرارتی و عملکردی ماشین‌های الکتریکی. این مدل شامل مدل‌سازی ریاضی، شبیه‌سازی دفع حرارت و ارزیابی راندمان کاری در سناریوهای مختلف بار بود و توصیه‌های عملی برای بهینه‌سازی طراحی ارائه می‌داد.
    </li>
    <li>
      طراحی و پیاده‌سازی یک چارچوب شبیه‌سازی برای الگوریتم‌های کنترلی سیستم‌های الکتریکی. این چارچوب ترکیبی از روش‌های عددی و برنامه‌نویسی برای مدل‌سازی دینامیک سیستم، شبیه‌سازی رفتار کنترلی و نمایش گرافیکی پایداری، عملکرد و سناریوهای بهینه‌سازی بود.
    </li>
  </ul>
</div>
  ...
  <div class="experience-item-fa" style="margin-bottom: 2em;">
    ...
    <ul class="responsibilities" style="font-size: 0.9em; line-height: 1.8; padding-right: 1.2em; margin-top: 0.8em; list-style-position: inside; font-family: 'Vazir', sans-serif; direction: rtl;">
      ...
      <li>ترکیب مدل‌های تحلیلی با رویکردهای طراحی مبتنی بر کاربرد، به‌منظور توسعه مفاهیم ایزولاسیون و اعتبارسنجی مبتنی بر داده در حوزه ماشین‌های فشار قوی.</li>
    </ul>
  </div>
</section>
...
<div class="experience-item-fa" style="margin-bottom: 2em;">
  ...
  <ul class="responsibilities" style="font-size: 0.9em; line-height: 1.8; padding-right: 1.2em; margin-top: 0.8em; list-style-position: inside; font-family: 'Vazir', sans-serif; direction: rtl;">
    ...
    <li>انتخاب و پیکربندی راه‌حل‌های سخت‌افزاری و نرم‌افزاری بهینه متناسب با سناریوهای مختلف کنترل فرآیند صنعتی، با تأکید بر مقرون به صرفه بودن و انطباق با مشخصات کارفرما و استانداردهای صنعتی.</li>
...
<section class="resume-section" style="direction: rtl; text-align: right; font-family: 'Vazir', sans-serif; color: #f5f5f5;">
  ...
  <div style="display: flex; flex-direction: column; gap: 0.8rem; font-size: 0.6rem;">
    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
      <div style="flex: 0 0 35%;">کارشناسی ارشد مهندسی برق - انرژی و اتوماسیون</div>
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-start; font-size: 0.6rem;">
      <div style="flex: 0 0 35%;">کارشناسی مهندسی برق - قدرت</div>
      <div style="flex: 0 0 60%; text-align: right;">
...
<section class="resume-section" style="font-family: 'Vazir', sans-serif; direction: rtl;">
  ...
  <p class="profile-text" style="
    ...
    font-family: 'Vazir', sans-serif;
    direction: rtl;">
   دارای پیشینه‌ای مستحکم در مهندسی برق هستم که بر پایه آموزش‌های تخصصی و تجربه عملی طولانی در حوزه‌های اتوماسیون، کنترل و تحلیل سیستم بنا شده است. علاوه بر پروژه‌های صنعتی متنوع، فعالیت‌های پژوهشی بین‌المللی نیز به من کمک کرده‌اند تا دیدگاه تحلیلی عمیق‌تر و مهارت‌های فنی گسترده‌تری کسب کنم.
  </p>
  ...
  <p class="profile-text" style="
    ...
    font-family: 'Vazir', sans-serif;
    direction: rtl;">
    در حال حاضر تمرکز اصلی من بر پروژه‌های تخصصی است که در آن‌ها دانش مهندسی برق را با برنامه‌نویسی و ریاضیات تلفیق می‌کنم تا مسائل پیچیده را مدل‌سازی، شبیه‌سازی و با رویکردی خلاقانه و کارآمد حل کنم.
  </p>
