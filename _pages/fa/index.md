...
<section class="resume-section" style="font-family: 'Vazir', sans-serif; direction: rtl;">
  ...
  <p class="profile-text" style="
    ...
    font-family: 'Vazir', sans-serif;
    direction: rtl;">
    مسیر حرفه‌ای من در مهندسی برق از سال ۱۳۷۹ آغاز شد و با تلفیق تحصیلات دانشگاهی و تجربه عملی در حوزه اتوماسیون و کنترل شکل گرفت. در ادامه، با تمرکز بیشتر بر ریاضیات، برنامه‌نویسی و مدل‌سازی، به‌ویژه در حل مسائل پیچیده مهندسی برق، این مسیر عمق بیشتری پیدا کرد. تجربه‌های پژوهشی دیدگاه تحلیلی و رویکرد منظم‌تری به من بخشید و کار مستقیم با ماشین‌های الکتریکی نیز مهارت‌های عملی‌ام را تقویت کرد. در حال حاضر تمرکز اصلی من بر انجام پروژه‌های تخصصی است که در آن‌ها تلفیق دانش مهندسی، ریاضیات و برنامه نویسی امکان بررسی و حل خلاقانه مسائل پیشرفته را فراهم می‌سازد.
  </p>
</section>
